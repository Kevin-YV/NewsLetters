...
export default function Home() {
  ...
  const URL = `https://newsapi.org/v2/everything?pageSize=18&q=latest&sortBy=publishedAt&apiKey=a14ea5887e1e443eadf762e469fe057a`;

  // Fetching new page

  // const handleFetch = (page) => {
  //   fetch(
  //     `https://newsapi.org/v2/everything?pageSize=18&q=latest&sortBy=publishedAt&apiKey=a14ea5887e1e443eadf762e469fe057a`
  //   )
