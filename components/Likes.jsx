...
export default function Likes() {
  ...
  useEffect(() => {
    if (name === "") {
      setStr("Log In to access favorites");
      ...
      const likes = accounts.map((el) => {
        name === el.name ? setNewsData(el.likes) : "";
      });
      newsData.length === 0 ? setStr("No favorites yet") : setStr("");
    }
  });
  ...
  return (
    <>
      <div className={styles.imgContainer} style={{ height: "300px" }}>
